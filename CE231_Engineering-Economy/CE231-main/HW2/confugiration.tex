...
\usepackage[a4paper, left=2cm, right=2cm, top=2cm, bottom=2cm, nomarginpar]{geometry}
\usepackage{hyperref}
\usepackage{changepage}


\usepackage{amsmath, trimclip, extarrows, algorithm, pgfplots, pgf, pdfpages, amsfonts, amssymb, stmaryrd, enumitem,graphicx, algpseudocode, setspace, listings, courier, color, caption, centernot, hyperref, lstautogobble, zi4, mathtools, lmodern, colortbl, array, multicol, fancyhdr, lastpage, booktabs}
